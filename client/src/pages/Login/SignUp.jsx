...
//     try {
//       const response = await axios.post('https://mlsa-b.onrender.com/api/user/register', data);
...
//       const response = await axios.post('https://mlsa-b.onrender.com/api/user/login', { email, password });
...
export { Container, FormWrapper, Title, Input, Button };
